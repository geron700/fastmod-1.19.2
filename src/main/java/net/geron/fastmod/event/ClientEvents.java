...
public class ClientEvents {
    @Mod.EventBusSubscriber(modid = Fastmod.MOD_ID, value = Dist.CLIENT)
    ...
    @Mod.EventBusSubscriber(modid = Fastmod.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
